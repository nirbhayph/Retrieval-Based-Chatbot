      ...
      for messaging_event in entry["messaging"]:
        ...
        if messaging_event.get("postback"):
          ...
          if str(messaging_event["postback"]["payload"].encode('unicode_escape'))=="SHOW_OPTIONS":
            ...
            mugs=["http://getsublimationblanks.co.uk/image/product/b/e/10oz-classic-white-mug-36-blanks-503.jpg","http://www.advancedscreenprinting.ca/sites/default/files/728_Bistro-blk-blank.jpg","http://omnihousewareinc.com/wp-content/uploads/2014/02/White_11oz_mug.jpg"]
