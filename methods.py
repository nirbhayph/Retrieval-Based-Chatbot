...
def make_image(bg_link,fg_link):
    ...
    with Image(file=bg) as bg_img:
        ...
        with pysftp.Connection(host="109.73.164.163", username="root", password="6kH%oVulTFBe", cnopts=cnopts) as sftp:
            sftp.put('pikachu.jpg', '/var/www/html/')
